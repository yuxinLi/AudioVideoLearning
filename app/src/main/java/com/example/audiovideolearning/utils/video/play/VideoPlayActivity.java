package com.example.audiovideolearning.utils.video.play;
...
public class VideoPlayActivity extends AppCompatActivity implements IPlayerCallBack {
    ...
    private String initData() {
        ...
        final BufferedInputStream in = new BufferedInputStream(
                getResources().openRawResource(R.raw.shape_of_my_heart));
