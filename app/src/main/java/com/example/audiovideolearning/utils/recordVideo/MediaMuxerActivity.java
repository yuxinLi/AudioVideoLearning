package com.example.audiovideolearning.utils.recordVideo;
...
public class MediaMuxerActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        Log.w("RecordActivity", "enter surfaceCreated method");
        this.surfaceHolder = surfaceHolder;
    }

    @Override
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i1, int i2) {
        Log.w("RecordActivity", "enter surfaceChanged method");
    }

    @Override
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        Log.w("RecordActivity", "enter surfaceDestroyed method");
        MediaMuxerThread.stopMuxer();
        stopCamera();
