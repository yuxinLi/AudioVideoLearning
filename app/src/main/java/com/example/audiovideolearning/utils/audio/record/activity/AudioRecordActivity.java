...
import com.example.audiovideolearning.utils.audio.record.record.AudioRecorder;
        ...
        switch (v.getId()) {
            case R.id.start:
                try {
                    ...
                    Toast.makeText(AudioRecordActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.pcmList:
                Intent showPcmList = new Intent(AudioRecordActivity.this, ListActivity.class);
                showPcmList.putExtra("type", "pcm");
                startActivity(showPcmList);
                break;

            case R.id.wavList:
                Intent showWavList = new Intent(AudioRecordActivity.this, ListActivity.class);
